@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-color: #ffd4ea" data-aos="fade">
    <div class="container">
    <div class="row align-items-start align-items-md-center justify-content-start">
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2">Cari Kebutuhan Anda di sini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Produk disini terjamin kualitasnya</p>
            <p>
